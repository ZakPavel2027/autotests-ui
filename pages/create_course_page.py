...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_title = page.get_by_test_id('create-course-toolbar-tite-text')
        ...
        self.crete_exercises_button = page.get_by_test_id('create-course-exercises-box-toolbar-create-exercise-button')
    ...
    def check_visible_create_exercises_button(self):
        expect(self.crete_exercises_button).to_be_visible()
