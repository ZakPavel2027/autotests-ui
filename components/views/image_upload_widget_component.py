...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page, identifier: str):
        ...
        self.preview_image = Image(
            page, f'{identifier}-image-upload-widget-preview-image', 'Image upload widget preview image'
        )

        self.image_upload_info_icon = Image(
            page, f'{identifier}-image-upload-widget-info-icon', 'Image upload widget info icon'
        )
        self.image_upload_info_title = Text(
            page,
            f'{identifier}-image-upload-widget-info-title-text',
            'Image upload widget info title text'
        )
        self.image_upload_info_description = Text(
            page,
            f'{identifier}-image-upload-widget-info-description-text',
            'Image upload widget info description text'
        )
        ...
        self.upload_input = FileInput(
            page, f'{identifier}-image-upload-widget-input', 'Image upload input'
        )
